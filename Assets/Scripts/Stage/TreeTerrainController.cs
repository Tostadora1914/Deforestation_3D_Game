...
namespace Deforestation
{
	...
	public class TreeTerrainController : MonoBehaviour
	{
		...
		//Terrain _terrain; // Por el componente "Terrain".
		//#endregion
		...
		//void Start()
		//{
		//	_terrain = Terrain.activeTerrain; // Se almacena en "_terrain", el terreno activo en la escena.
  //          _trees = _terrain.terrainData.treeInstances; // En el array "_tree", se almacenarán todos los árboles (instancias) del terreno.
  ...
  //          InitializeTrees();
		...
		//{
  //          // Este "for" irá decrementando su índice mientras que este (el índice) sea mayor o igual a 0.
  //          for (int i = _trees.Length - 1; i >= 0; i--) // Bucle (recorrer lista) con índice "i", el cual empieza en la última posición del array "_trees" y termina en la primera posición.
  //          {
